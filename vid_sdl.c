...
#define    BASEWIDTH    510
#define    BASEHEIGHT   384
#define    DISABLE_CDROM

int min_vid_width = 510;
...
void    VID_Init (unsigned char *palette)
{
 ...
 //   if ( COM_CheckParm ("-fullscreen") )
   //     flags |= SDL_FULLSCREEN;
    ...
    // Initialize display 
    screen = SDL_CreateRGBSurface(SDL_HWSURFACE, vid.width, vid.height, 8, 0, 0, 0, 0);
//    screen = SDL_CreateRGBSurface(SDL_SWSURFACE, 160, 120, 8, 0, 0, 0, 0);
