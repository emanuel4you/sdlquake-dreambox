...
void M_AdjustSliders (int dir)
{
	...
	case 5:	// music volume
		...
		if ((bgmvolume.value>0) && (bgmvolume.value<0.2) && (dir==1)) {
		  CDAudio_Resume();
		}
	...
	case 9:	// lookstrafe
		...
		break;
		/*
	case 10:	// doublesizeset
		Cvar_SetValue ("doublesizeset", (int)!doublesizeset.value);
		if (doublesizeset.value) {
		  scr_viewsize.value = 50;
		} else {
	...
	case 11:	// doublesize status bar
		Cvar_SetValue ("doublesizestatus", (int)!doublesizestatus.value);		vid.recalc_refdef = 1;
		break;
		*/
#ifdef _WIN32
...
/*
	...
	M_DrawSlider (148, 72, r);
*/
	M_Print (16, 72, "    CD Volume");
	r = bgmvolume.value;
	...
	M_DrawCheckbox (140/*220*/, 88, cl_forwardspeed.value > 200);
	/*
	M_Print (16, 104, "  Invert Mouse");
	M_DrawCheckbox (140, 104, m_pitch.value < 0);
	*/
	M_Print (16, 96, "    Lookspring");
	M_DrawCheckbox (140/*220*/, 96, (int)lookspring.value);

	M_Print (16, 104, "    Lookstrafe");
	M_DrawCheckbox (140/*220*/, 104, (int)lookstrafe.value);
	/*
	M_Print (16, 112, "   Double Size");
	M_DrawCheckbox (140, 112, (int)doublesizeset.value);

	M_Print (16, 120, "   DS SBar");
	M_DrawCheckbox (140, 120, (int)doublesizestatus.value);
*/
	if (vid_menudrawfn)
...
void M_Keys_Key (int k)
{
	...
	case K_ENTER:
	case K_MOUSE1:		// go into bind mode
...
{
	//Dan:
  //	if (!bind_grab&&key==K_JOY1) key=K_MOUSE1;
	switch (m_state)
	{
	case m_none:
		return;
